...
CheckBox::CheckBox(wxWindow *parent, int id)
    ...
    , m_on(this, "zaxe_check_on", 18)
    , m_half(this, "zaxe_check_half", 18)
    , m_off(this, "zaxe_check_off", 18)
    , m_on_disabled(this, "zaxe_check_on_disabled", 18)
    , m_half_disabled(this, "zaxe_check_half_disabled", 18)
    , m_off_disabled(this, "zaxe_check_off_disabled", 18)
    , m_on_focused(this, "zaxe_check_on_focused", 18)
    , m_half_focused(this, "zaxe_check_half_focused", 18)
    , m_off_focused(this, "zaxe_check_off", 18)
{
