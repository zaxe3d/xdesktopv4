    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(0, 134, 201), StateColor::Pressed);
    border_color.append(wxColour(54, 191, 250), StateColor::Hovered);
    border_color.append(0x009ADE, StateColor::Normal);
    ...
    background_color.append(wxColour(0, 134, 201), StateColor::Pressed);
    background_color.append(wxColour(54, 191, 250), StateColor::Hovered);
    background_color.append(0x009ADE, StateColor::Normal);
