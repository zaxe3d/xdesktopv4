...
#else // _WIN32
    return wxIcon(Slic3r::var("XDesktop_128px.png"), wxBITMAP_TYPE_PNG);
#endif // _WIN32
}
...
*/
    ...
    case GUI_App::EAppMode::Editor:
        ...
        m_taskbar_icon->SetIcon(wxIcon(Slic3r::var("XDesktop-mac_256px.ico"), wxBITMAP_TYPE_ICO), "XDesktop");
        break;
...
// #endif
    ...
    if (shown2 == show)
        ...
        m_tabpanel->InsertPage(tpCalibration, m_calibration, _L("Calibration"), std::string("zaxe_tab_devices"), std::string("zaxe_tab_devices"), false);
    else
    ...
    m_mode_option_btn->Bind(wxEVT_BUTTON, [this](wxCommandEvent& event)
        {
            ...
            Button* slice_all_btn = new Button(p, _L("Slice all"), "", wxBORDER_NONE);
