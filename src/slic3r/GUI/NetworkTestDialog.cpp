...
{
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(0, 134, 201), StateColor::Pressed), std::pair<wxColour, int>(wxColour(54, 191, 250), StateColor::Hovered), std::pair<wxColour, int>(wxColour(255, 255, 255), StateColor::Enabled));
...
wxBoxSizer* NetworkTestDialog::create_info_sizer(wxWindow* parent)
{
	...
	text_version_title = new wxStaticText(this, wxID_ANY, _L("XDesktop Version:"), wxDefaultPosition, wxDefaultSize, 0);
...
wxBoxSizer* NetworkTestDialog::create_content_sizer(wxWindow* parent)
{
    ...
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(0, 134, 201), StateColor::Pressed),std::pair<wxColour, int>(wxColour(54, 191, 250), StateColor::Hovered), std::pair<wxColour, int>(wxColour(255,255,255), StateColor::Enabled));
	btn_link = new Button(this, _L("Test XDesktop(GitHub)"));
    btn_link->SetBackgroundColor(btn_bg);
	grid_sizer->Add(btn_link, 0, wxEXPAND | wxALL, 5);

	text_link_title = new wxStaticText(this, wxID_ANY, _L("Test XDesktop(GitHub):"), wxDefaultPosition, wxDefaultSize, 0);
...
void NetworkTestDialog::start_all_job_sequence()
{
	m_sequence_job = new boost::thread([this] {
        ...
        if (m_closing) return;
		start_test_url(TEST_ORCA_JOB, "XDesktop(GitHub)", "https://github.com/zaxe3d/xdesktopv4");
		if (m_closing) return;
