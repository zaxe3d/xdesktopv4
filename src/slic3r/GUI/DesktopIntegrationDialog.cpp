...
void DesktopIntegrationDialog::perform_desktop_integration()
{
    ...
    for (size_t i = 0; i < target_candidates.size(); ++i) {
        ...
        if (contains_path_dir(target_candidates[i], "images")) {
            ...
            std::string icon_path = GUI::format("%1%/images/XDesktop.png",resources_dir());
            std::string dest_path = GUI::format("%1%/images/%2%XDesktop%3%.png", target_dir_icons, icon_theme_path, version_suffix);
    ...
    if(target_dir_icons.empty()) {
    	...
    	// save path to icon
        app_config->set("desktop_integration_icon_slicer_path", GUI::format("%1%/images/%2%XDesktop%3%.png", target_dir_icons, icon_theme_path, version_suffix));
    ...
    for (size_t i = 0; i < target_candidates.size(); ++i)
    {
        if (contains_path_dir(target_candidates[i], "applications")) {
            ...
            std::string desktop_file = GUI::format(
                ...
                "StartupNotify=false\n"
                "StartupWMClass=xdesktop-slicer\n", name_suffix, version_suffix, excutable_path);
