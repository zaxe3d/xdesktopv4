    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = ScalableBitmap(this, Slic3r::var("XDesktop_192px.png"), wxBITMAP_TYPE_PNG);
...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("XDesktop is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("XDesktop is based on Orca Slicer, which is from PrusaSlicer by Prusa Research.  PrusaSlicer is from Slic3r by Alessandro Ranellucci and the RepRap community"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // logo
    m_logo_bitmap = ScalableBitmap(this, "studio_logo", 250);
    ...
    // version
    {
        ...
        auto version_string = _L("XDesktop ") + " " + std::string(SoftFever_VERSION);
        wxStaticText* version = new wxStaticText(this, wxID_ANY, version_string.c_str(), wxDefaultPosition, wxDefaultSize);
        wxStaticText* bs_version = new wxStaticText(this, wxID_ANY, wxString::Format("Based on OrcaSlicer and PrusaSlicer"), wxDefaultPosition, wxDefaultSize);
...
// #endif
    ...
    text_list.push_back(_L("XDesktop is based on OrcaSlicer, BambuStudio, PrusaSlicer, and SuperSlicer."));
    ...
    wxStaticText *html_text = new wxStaticText(this, wxID_ANY, "Copyright(C) 2022-2024 Zaxe3D All Rights Reserved", wxDefaultPosition, wxDefaultSize);
    ...
    m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_NEVER /*NEVER*/);
      {
          ...
          const auto text = from_u8(
              ...
              "<html>"
              "<body>"
              "<p style=\"text-align:left\"><a style=\"color:#009ADE\" href=\"https://github.com/zaxe3d/xdesktopv4\">https://github.com/zaxe3d/xdesktopv4</ a></p>"
              "</body>"
              "</html>")
            ).str());
          m_html->SetPage(text);
