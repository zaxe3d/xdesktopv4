...
PingCodeBindDialog::~PingCodeBindDialog() {
     ...
     : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, _L("Log in printer"), wxDefaultPosition, wxDefaultSize, wxCAPTION)
 {
     ...
     m_link_Terms_title->SetForegroundColour(wxColour(0x009ADE));
     ...
     m_link_privacy_title->SetForegroundColour(wxColour(0x009ADE));
     ...
     m_link_notice_title->SetForegroundColour(wxColour(0x009ADE));
