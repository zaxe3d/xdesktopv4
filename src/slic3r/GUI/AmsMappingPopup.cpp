    ...
    :PopupWindow(parent, wxBORDER_NONE)
{
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(0, 154, 222), StateColor::Pressed), std::pair<wxColour, int>(wxColour(0, 154, 222), StateColor::Normal));
...
void AmsReplaceMaterialDialog::create()
{
    ...
    label_title->SetForegroundColour(0x009ADE);
