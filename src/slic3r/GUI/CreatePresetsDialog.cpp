...
#define SELECT_ALL_OPTION_COLOUR wxColour("#009ADE")
...
wxBoxSizer *CreatePrinterPresetDialog::create_hot_bed_stl_item(wxWindow *parent)
{
    ...
    StateColor flush_bd_col(std::pair<wxColour, int>(wxColour(0, 154, 222), StateColor::Pressed), std::pair<wxColour, int>(wxColour(0, 154, 222), StateColor::Hovered),
    ...
    : DPIDialog(parent ? parent : nullptr, wxID_ANY, PRINTER == create_success_type ? _L("Create Printer Successful") : _L("Create Filament Successful"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    case FILAMENT: 
        ...
        wxString sync_text = sync_user_preset_need_enabled ? _L("\n\nXDesktop has detected that your user presets synchronization function is not enabled, which may result in unsuccessful Filament settings on "
