...
static const wxColour TEXT_NORMAL_CLR = wxColour(0, 154, 222);
    ...
    :wxPanel(parent, id, pos, size, style)
{
    ...
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(255, 255, 255), StateColor::Disabled), std::pair<wxColour, int>(wxColour(0, 134, 201), StateColor::Pressed),
                      std::pair<wxColour, int>(wxColour(54, 191, 250), StateColor::Hovered), std::pair<wxColour, int>(wxColour(0, 154, 222), StateColor::Enabled),
                      std::pair<wxColour, int>(wxColour(0, 154, 222), StateColor::Normal));
    StateColor btn_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(0, 154, 222), StateColor::Enabled));
    ...
    if (m_obj && m_show_consistency_hint) {
        if (m_obj->upgrade_consistency_request) {
            ...
            consistency_dlg->update_text(_L(
                 "The firmware version is abnormal. Repairing and updating are required before printing. Do you want to update now? You can also update later on printer or update next time starting XDesktop."
            ));
