...
static const wxColour BUTTON_HOVER_COL   = wxColour(0, 154, 222);
...
static const wxColour STAGE_TEXT_COL      = wxColour(0, 154, 222);
...
void PrintingTaskPanel::create_panel(wxWindow* parent)
{
   ...
   /* wxFlexGridSizer *fgSizer_task = new wxFlexGridSizer(2, 2, 0, 0);
    ...
    m_staticText_progress_percent->SetForegroundColour(wxColour(0, 154, 222));
    ...
    m_staticText_progress_percent_icon->SetForegroundColour(wxColour(0, 154, 222));
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(AMS_CONTROL_DISABLE_COLOUR, StateColor::Disabled), std::pair<wxColour, int>(wxColour(0, 134, 201), StateColor::Pressed),
                            std::pair<wxColour, int>(wxColour(54, 191, 250), StateColor::Hovered), std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Normal));
...
wxBoxSizer *StatusBasePanel::create_misc_control(wxWindow *parent)
{
    ...
    m_switch_nozzle_fan->Bind(wxEVT_ENTER_WINDOW, [this](auto& e) {
        m_fan_panel->SetBackgroundColor(wxColour(0, 154, 222));
    });
...
void ScoreDialog::init() {
    ...
    // icon
    std::string icon_path = (boost::format("%1%/images/XDesktop.ico") % resources_dir()).str();
