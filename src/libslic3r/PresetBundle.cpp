...
const char *PresetBundle::BBL_BUNDLE = "Zaxe";
const char *PresetBundle::BBL_DEFAULT_PRINTER_MODEL = "Zaxe Z3S - 0.4mm Revo HF nozzle";
const char *PresetBundle::BBL_DEFAULT_PRINTER_VARIANT = "0.4";
const char *PresetBundle::BBL_DEFAULT_FILAMENT = "Zaxe PLA @Z3S";
...
VendorType PresetBundle::get_current_vendor_type()
{
    ...
    auto vendor_name = get_current_vendor();
...
std::string PresetBundle::get_current_vendor()
{
